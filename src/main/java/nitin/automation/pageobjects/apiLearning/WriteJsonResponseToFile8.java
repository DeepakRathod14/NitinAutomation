...
/**
 * 1. As byte array :- asByteArray() 2. As input stream :- asInputStream() 3. As
 * string :- asString()
 * Guava: (google > file lib) will be used for store response into json file.
 * @author Deepak.Rathod
 *
 */
public class WriteJsonResponseToFile8 {
	...
	public static void main(String[] args) throws IOException {
		...
		// Directly getting a byte array [ optimal way is this ]
